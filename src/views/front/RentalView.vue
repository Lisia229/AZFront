<template>
  <div id="rentalView" class="relative w-full h-full flex flex-wrap justify-center items-center">
    ...
    <router-link id="AZpark" to="/rental/63e25d92384dcac8bdbb00c0" class="hidden lg:block px-4 right-[500px] py-2 absolute bg-black text-white rounded-3xl">
      AZ劇場
    </router-link>
    <router-link
      id="AZRoom"
      to="/rental/63e4f0a17362e713cd1787f8"
      class="hidden lg:block px-4 top-[400px] right-[300px] 2xl:right-[400px] py-2 absolute bg-black text-white rounded-3xl">
      展覽會館
    </router-link>
    <router-link
      id="AZHouse"
      to="/rental/63e4f1ab7362e713cd178801"
      class="hidden lg:block px-4 bottom-[350px] right-[700px] 2xl:right-[1000px] py-2 absolute bg-black text-white rounded-3xl">
      玻璃貨櫃屋
    </router-link>
  </div>
